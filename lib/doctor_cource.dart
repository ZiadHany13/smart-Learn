...
class Doctor_Cource extends StatefulWidget {
  @override
  State<Doctor_Cource> createState() => _Doctor_CourceState();
}

class _Doctor_CourceState extends State<Doctor_Cource> {
  @override
        ...
        Container(
          ...
          Column( //mainAxisAlignment: MainAxisAlignment.spaceAround,mainAxisSize: MainAxisSize.min,
            ...
            children: [
              ...
              Text(textAlign: TextAlign.start,
                'Hi Doctor,Upload lectures Here',
