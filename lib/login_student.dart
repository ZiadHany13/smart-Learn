...
import 'package:the_project/signupstudent.dart';
...
class _LoginStudentState extends State<LoginStudent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor:Colors.white ,
     // appBar: AppBar(backgroundColor:Colors.white, title: Text("Smart Learn",textAlign: TextAlign.center,style:TextStyle(fontSize: 27)),),
      endDrawer: Drawer(),
      body:
          ...
          Column( //mainAxisAlignment: MainAxisAlignment.spaceAround,mainAxisSize: MainAxisSize.min,
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(
                ...
                child:
                ElevatedButton(onPressed: () {Navigator.of(context).push(MaterialPageRoute(builder: (ctx) =>StudentHome()));
                  //print(username.text);
              ...
              Padding(padding: EdgeInsets.only(
                ...
                ElevatedButton(
                  ...
                  Navigator.of(context).push(
                      MaterialPageRoute(builder: (ctx) => SignupStudent()));
                },
                  child: Text(
